...
public class AgeApp {
    ...
    /**
     * Outputs some "funny" sentences depending on the given age.
    ...
    private static void printFunnyAgeSentence(int age) {
        if (age < 10) {
            ...
            System.out.println("Dags att pensionspara!");
        } else {
    ...
    /**
     * Ask the user which year they are born. Only accepts years in the range
     * 1900-2024.
     * 
